...
BitcoinGUI::BitcoinGUI(QWidget *parent):
    ...
    nWeight(0)
{
    setFixedSize(1106, 550);
	QFontDatabase::addApplicationFont(":/fonts/Bebas");
    setWindowTitle(tr("BitBoSS") + " - " + tr("Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a BitBoSS address"));
...
//	nodeAction = new QAction(QIcon(":/icons/address-book"), tr(""), this);
  //  nodeAction->setToolTip(tr(""));
  //  nodeAction->setCheckable(true);
   ...
   // tabGroup->addAction(nodeAction);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About BitBoSS"), this);
    aboutAction->setToolTip(tr("Show information about BitBoSS"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qtlogo-64"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for BitBoSS"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("BitBoSS client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("BitBoSS client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitBoSS network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BitBoSS address or malformed URI parameters."));
    }
